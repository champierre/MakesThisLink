function makesthis_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
makesthis_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				makesthis_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
makesthis_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
makesthis_xmlhttpRequester.prototype.setupRequestEvent =
